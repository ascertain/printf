 ...
 * @bufffer: buffer array that handles print
 ...
 * @buffer: buffer arry that handles print
...
int print_string(va_list types, car buffer[], int flags, int width, int precision, in size)
{
	int length = 0, i;
...
*/
		int print_int(va_list types, char buffer[], int flags, int width, int precision, int size)
		{
			int  i = BUFF_SIZE - 2;
			int is_negative = 0;
			long int n = va_arg(types, long int0;
